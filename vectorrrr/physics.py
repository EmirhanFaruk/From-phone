...
for i in range(500):
    balls.append(Ball(randint(100, monitor_width-100), randint(100, monitor_height-100), 1, [0, 0], 40, randint(1, 355), 0, (randint(100, 255), randint(100, 255), randint(100, 255))))#(255, 255, 0)))#(randint(100, 255), randint(100, 255), randint(100, 255))))#(randint(70, 170), randint(170, 255), randint(100, 200))))#(120, 250, 150)))
...
while running:
    ...
    if c >= 60:
    	c = 0
    	balls.append(Ball(randint(100, monitor_width-100), randint(100, monitor_height-100), 1, [0, 0], 40, randint(1, 355), 0, (255, 255, 0)))
